...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">博客网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Blog/frontlist?blogClassObj.blogClassId=1">娱乐</a></li>
                <li><a href="<%=basePath %>Blog/frontlist?blogClassObj.blogClassId=2">体育</a></li>
                <li><a href="<%=basePath %>Blog/frontlist?blogClassObj.blogClassId=3">女性</a></li>
                <li><a href="<%=basePath %>Blog/frontlist?blogClassObj.blogClassId=4">美食</a></li>
                <li><a href="<%=basePath %>Blog/frontlist?blogClassObj.blogClassId=5">设计</a></li>
                <li><a href="<%=basePath %>Blog/frontlist?blogClassObj.blogClassId=6">时尚</a></li>
                <li><a href="<%=basePath %>Blog/frontlist?blogClassObj.blogClassId=7">其他</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Blog/blog_frontUserAdd.jsp"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;发布博客文章 </a></li>
                        <li><a href="<%=basePath %>Blog/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我发布的博客</a></li>
                        ...
                        <li><a href="<%=basePath %>Comment/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我发布的评论</a></li>
