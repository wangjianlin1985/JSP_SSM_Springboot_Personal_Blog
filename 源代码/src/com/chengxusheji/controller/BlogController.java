...
public class BlogController extends BaseController {
	...
	public void userAdd(Blog blog, BindingResult br,
		...
		blog.setUserObj(userObj);
		
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		blog.setAddTime(sdf.format(new java.util.Date()));
	...
	public String userFrontlist(@ModelAttribute("blogClassObj") BlogClass blogClassObj,String title,@ModelAttribute("userObj") UserInfo userObj,String addTime,String shzt,Integer currentPage, Model model, HttpServletRequest request,HttpSession session) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (title == null) title = "";
		if (addTime == null) addTime = "";
		if (shzt == null) shzt = "";
	    ...
	    List<UserInfo> userInfoList = userInfoService.queryAllUserInfo();
	    request.setAttribute("userInfoList", userInfoList);
		return "Blog/blog_userFrontquery_result"; 
	}
	...
	public String frontshow(@PathVariable Integer blogId,Model model,HttpServletRequest request) throws Exception {
        ...
        blog.setHitNum(blog.getHitNum() + 1);
        ...
        ArrayList<Comment> commentList = commentService.queryComment(blog, null, "");
