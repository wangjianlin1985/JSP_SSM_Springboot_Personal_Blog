...
public class CommentService {
    ...
    /*按照查询条件分页查询博客评论记录*/
    public ArrayList<Comment> queryComment(Blog blogObj,UserInfo userObj,String commentTime,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(null != blogObj && blogObj.getBlogId()!= null && blogObj.getBlogId()!= 0)  where += " and t_comment.blogObj=" + blogObj.getBlogId();
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Comment> queryComment(Blog blogObj,UserInfo userObj,String commentTime) throws Exception  { 
     	String where = "where 1=1";
    	if(null != blogObj && blogObj.getBlogId()!= null && blogObj.getBlogId()!= 0)  where += " and t_comment.blogObj=" + blogObj.getBlogId();
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_comment.userObj='" + userObj.getUser_name() + "'";
    	if(!commentTime.equals("")) where = where + " and t_comment.commentTime like '%" + commentTime + "%'";
